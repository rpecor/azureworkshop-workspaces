...
module "networking" {
  source  = "app.terraform.io/CSG/networking/azurerm"
  version = "0.0.1"
...
module "webserver" {
  source  = "app.terraform.io/CSG/webserver/azurerm"
  version = "0.0.1"
...
module "appserver" {
  source  = "app.terraform.io/CSG/appserver/azurerm"
  version = "0.0.1"
...
module "dataserver" {
  source  = "app.terraform.io/CSG/dataserver/azurerm"
  version = "0.0.1"
